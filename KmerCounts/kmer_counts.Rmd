...
output:
  rmdformats::downcute:
    self_contained: true
github: "https://github.com/camilogarciabotero"
---
...
[![](carbon_kmer_count.png)](https://github.com/camilogarciabotero/Biolibrary)
...
kmers_plot <- total %>%
  ...
  ggsave("kmers_freq_01.png", width = 10, height = 10, dpi = 400)
